...
const Testimonies = props => {
    return (
        <div className="flex flex-wrap gap-10 justify-evenly max-w-6xl mx-auto -mt-80 ">
            <CardTestimony image={reviewCesar} goTo='https://www.linkedin.com/in/Damian-demasi/' personName='Ariel Villagra' jobPosition={
                <>
            ...
            <CardTestimony image={reviewAdrian} goTo='https://www.linkedin.com/in/Damian-demasi/' personName='Adrin Dzienisik' jobPosition={
                <>
