        ...
        <div className='bg-black'>
            <section id="section-projects">
                ...
                <ProjectRight
                    ...
                    buttonWatchItLive={'https://jirokobadev.github.io/'}
                    ...
                    buttonGitHub={'https://github.com/jirokobadev/'}>
                    <ParagraphLight>
                    ...
                    <ParagraphLight>
                        <p>APIs are reliableâ€¦ most of the time ðŸ¤­. I'm sure paid APIs perform better, so if I need to use them in the future for a more serious project, I will research deeply what is the best API to get for the job.</p>
                    </ParagraphLight>
                    <ParagraphLight>
                ...
                <ProjectLeft
                    ...
                    bgImage={'bg-to-do'}
                    techStack={['HTML5', 'CSS3', 'GitHub', 'JS', 'Figma', 'Netlify']}
                    buttonWatchItLive={'https://jirokobadev.github.io/mini-projects/todo-app/'}
          ...
          <SectionHeader text={'Code Library'} headerGradientStyle={'header-projects'} className={'mt-52'} />
          <div className='flex flex-wrap md:flex-nowrap gap-10 max-w-5xl m-auto mt-32 px-2'>
            <div>
